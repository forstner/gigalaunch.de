...
$footer = '<div data-role="footer">
				<div data-role="navbar">
					<ul>
						...
						<li>
							<a data-icon="bars" rel="external" href="template.php#subpage2" tooltip="load link via ajax into this page (js of page to load will">link to subdivpage2</a>
						</li>
						<li>
							<a data-icon="forward" rel="external" href="useradd.php" data-role="button" data-inline="true" data-mini="true" tooltip="this will completely load/go to an external page, initializing all the javascript of this external page, which is good if you plan to do modular web applications">go to external page</a>
						</li>
					</ul>
				</div>
				<!-- /navbar -->
...
$header = '
		<div data-role="header" data-position="inline" data-backbtn="true">
			<div class="ui-bar ui-bar-b">
				...
				<a class="nav_button home" data-theme="e" href="useradd.php" data-role="button" data-inline="true" data-mini="true" data-icon="plus" rel="external" data-ajax="false">useradd</a>
			</div>
		</div>
		';
?>
...
<body> 
	...
	<div data-role="page" id="subpage1">
		...
		<div data-role="content">
			...
			<br>
			meaning: instead of putting everything inside one page, there are components (useradd.php)
			...
			meaning:
			<br>
			login.php -> does login, nothing else<br>
			useradd.php -> allows you to add users (this dialog can be reused)<br>
			<br>
			testing:
			<br>
