/* backend used */
var backendUrl =  "lib/lib_users_and_groups.php";
 ...
 * */
function generateUserlist(where)
{
 ...
 * */
function generateGrouplist(where,type = "checkboxes")
{
...
*/
function groups(ResultHandler,group = null,uniqueKey = null,uniqueValue = null,where = "")
{
	if(!uniqueValue)
	{
		if(group)
