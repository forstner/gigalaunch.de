...
require ('../library/lib_users_mysql_passwd.php');
...
<body>
	<div data-role="page" id="login">
		...
		<div data-role="content">
			<h4>Login:</h4>
			<form id="loginForm" class="loginForm" action="frontend_frontend_login.php" method="post" accept-charset="UTF-8" data-ajax="false">
		...
		<div data-role="footer">
			...
			<a href="backend_useradd.php" rel="external">register</a>
		</div> 
	</div>
</body>
</html>