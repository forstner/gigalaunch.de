...
if($is_admin)
{
	if($group == "admins") {
		// highlight
		echo '<a href="UserManagement.php?group=admins" rel="external" data-ajax="false" class="nav_button admins" data-role="button" data-theme="e" data-inline="true" data-mini="true" data-icon="bars">admins</a>';
	}
	else {
		echo '<a href="UserManagement.php?group=admins" rel="external" data-ajax="false" class="nav_button admins" data-role="button" data-theme="a" data-inline="true" data-mini="true" data-icon="bars">admins</a>';
	}
	
	if($group == "users") {
		// highlight
		echo '<a href="UserManagement.php?group=users" rel="external" data-ajax="false" class="nav_button users" data-role="button" data-theme="e" data-inline="true" data-mini="true" data-icon="bars">users</a>';
	}
	else {
		echo '<a href="UserManagement.php?group=users" rel="external" data-ajax="false" class="nav_button users" data-role="button" data-theme="a" data-inline="true" data-mini="true" data-icon="bars">users</a>';
	}
}

if($group == "yourself") {
	// highlight
	echo '<a href="UserManagement.php?group=yourself" rel="external" data-ajax="false" class="nav_button yourself" data-role="button" data-theme="e" data-inline="true" data-mini="true" data-icon="bars">yourself</a>';
}
else {
	echo '<a href="UserManagement.php?group=yourself" rel="external" data-ajax="false" class="nav_button yourself" data-role="button" data-theme="a" data-inline="true" data-mini="true" data-icon="bars">yourself</a>';
}


echo '
		<a href="useradd.php" rel="external" data-ajax="false" class="nav_button home" data-theme="a" data-role="button" data-inline="true" data-mini="true" data-icon="plus">useradd</a>
	</div>
</div>
