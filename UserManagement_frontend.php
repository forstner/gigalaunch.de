...
<html lang="en">
  ...
  <body>
    ...
    $(document).ready(function() {
        $(".listOfusers").usersList(function()
									{
										// resulthandler
									},
	  								'<div class="col-6 col-sm-6 col-lg-4"><div class="thumbnail"><img class="profilePicture" src="$profilePicture" alt="profile Picture"><div class="caption"><h3>$firstname $lastname</h3><p>Username: $username</p><p>mail: <a href="mailto:$mail">$mail</a></p><p style="text-align: right;"><a href="#" class="btn btn-primary" role="button">Edit</a></p></div></div></div>');
    });
    </script>
</body>
</html>